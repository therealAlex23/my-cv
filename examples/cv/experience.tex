...
%---------------------------------------------------------
  \cventry
	...
	\item {Engineered Design Assurance Level A and D critical flight software components operating on a Real-Time Operating System (RTOS), in compliance with DO-178C and DO-330 standards following a V-Model lifecycle. Successfully contributed to major releases, including one achieving Stage of Involvement 3 (SOI-3) certification;}
...
%---------------------------------------------------------
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Tested Random Forest and Gradient Boosting models with Homomorphic encryption methods within an innovative distributed learning framework in Python;}
